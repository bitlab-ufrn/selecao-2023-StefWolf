  ...
  return (
    <body className='body'>
      <div className='w-[90%] laptop:mb-0 mb-7 flex justify-end'>
        {theme === "ligth" ? (
          <button className='bg-black/10 p-3 gap-2 text-blue-gray-900 rounded-lg flex' onClick={()=> setTheme("dark")}>
            <FaMoon size={20} /><p>Escuro</p>
          </button>) 
        :(<button className='bg-black/70 p-3 gap-2 -text--text-color rounded-lg flex' onClick={()=> setTheme("ligth")}>
